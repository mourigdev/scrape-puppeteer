...
//         console.log(document.querySelector("#loginP2").value)
//       document.querySelector("#loginP2").value = "upwork22";
//       document.querySelector("#loginP").value = "upwork22";
//       document.querySelector("#go > input[type=image]").click()
...
//     //     return [];
//     //   }
//     //const el = document.querySelector("#main_content_Admin > div:nth-child(3) > div.text-center.txt-md.pad-10")
//     return ;
//     });
